                ...
                <table data-plugin="datatables" class="table table-striped table-bordered" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?= $data->username ?></td>
                      <td>
                        <a href="<?= base_url('edit/'.$data->id) ?>" class="btn btn-rect btn-sm btn-warning"><i class="fa fa-edit"></i> Edit</a>
                        <a href="<?= base_url('delete/'.$data->id) ?>" class="btn btn-rect btn-sm btn-danger"><i class="fa fa-trash"></i> Hapus</a>
                      </td>
                    </tr>
